...
export default {
    ...
    methods: {
        ...
        group_add(){
         this.group_div = true;
        //  window.console.log(this.$store.state.Equipment.device);
        //  window.console.log(this.group_decive);
        //  let get_device_data = [];
        //  let get_device_id = [];
        //  let get_device_name = [];
        //  get_device_data=this.$store.state.Equipment.device
        //  window.console.log(get_device_data);
        //  for(var i=0;i<= get_device_data.length-1;i++){
        //      get_device_id.push(get_device_data[i].id);
        //      get_device_name.push(get_device_data[i].alias_name);

        //  }
        //  window.console.log(get_device_id);
        //  window.console.log(get_device_name);
        //  window.console.log(111111);

        //  this.data_id = get_device_id
        //  this.data_name = get_device_name
        //  window.console.log(this.data_id);
        //  window.console.log(this.data_name);
        }
    },
    computed:{
    //    get_group_list(){
    //      return this.data_id = this.get_device_id
    //      return this.data_name = this.get_device_name
    //    }
            group_list(){
